...
class DMABleManager(applicationContext: Context, private val dmaServiceListener: DMAServiceListener? = null) : BleManager(applicationContext) {
    ...
    override fun isRequiredServiceSupported(gatt: BluetoothGatt): Boolean {
        val foundCharacteristics = mutableListOf<String>()

        Log.d(TAG, "isRequiredServiceSupported - discovered services:")
        for (service in gatt.services) {
            Log.d(TAG, service.uuid.toString())
            foundCharacteristics.addAll(service.characteristics.map { c -> c.uuid.toString() })
        }
        ...
        */
        ...
        val requiredCharacteristics : List<String> = listOf("00002a2b-0000-1000-8000-00805f9b34fb",
            "3c0a1001-281d-4b48-b2a7-f15579a1c38f", "3c0a1002-281d-4b48-b2a7-f15579a1c38f",
            "3c0a1003-281d-4b48-b2a7-f15579a1c38f")

        return foundCharacteristics.containsAll(requiredCharacteristics)
